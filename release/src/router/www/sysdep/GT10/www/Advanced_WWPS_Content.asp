			...
			<tr id="wps_band_tr">
				...
				<td  id="wps_select" style="display:none">
						<select name="wps_unit" class="input_option" onChange="SelectBand();">
							<option id="wps_opt0" class="content_input_fd" value="2" <% nvram_match("wps_band_x", "2","selected"); %>>2.4 GHz</option>
							<option id="wps_opt1" class="content_input_fd" value="0" <% nvram_match("wps_band_x", "0","selected"); %>>5 GHz-1</option>
							<option id="wps_opt2" class="content_input_fd" value="1" <% nvram_match("wps_band_x", "1","selected"); %>>5 GHz-2</option>
						</select>			
				</td>
			</tr>
