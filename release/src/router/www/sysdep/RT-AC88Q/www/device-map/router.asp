...
$(function () {
	...
	if(parent.amesh_support && ((parent.isSwMode("RT") || parent.isSwMode("WISP")) || parent.isSwMode("ap")) && parent.ameshRouter_support)
		dynamic_include_js('/require/modules/amesh.js');
	if(parent.smart_connect_support && ((parent.isSwMode("RT") || parent.isSwMode("WISP")) || parent.isSwMode("ap")))
...
function initial(){
	...
	if(parent.smart_connect_support && ((parent.isSwMode("RT") || parent.isSwMode("WISP")) || parent.isSwMode("ap"))){
		...
		if(parent.based_modelid == "RT-AC5300" ||
			parent.based_modelid == "GT-AC5300" || 
