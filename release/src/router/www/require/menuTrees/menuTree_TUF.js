		...
		list: [
			...
			*/
			...
			
			{
				...
				index: "menu_CPUPOWER",
				tab: [
					{url: "Advanced_CPUPOWER_Content.asp", tabName: "CPU 调度"},
					{url: "NULL", tabName: "__INHERIT__"}
				]
			},
			{
				...
				index: "menu_MULTIWAN",
				tab: [
					{url: "Advanced_MULTIWAN_Content.asp", tabName: "Multi-WAN"},
					{url: "NULL", tabName: "__INHERIT__"}
				]
			},
			{
				...
				index: "menu_VLANMGR",
				tab: [
					{url: "Advanced_VLAN_MGR_Content.asp", tabName: "VLAN 管理"},
					{url: "NULL", tabName: "__INHERIT__"}
				]
			},
			{
				...
				index: "menu_FBCUSTOM",
				tab: [
					{url: "Advanced_FBCUSTOM_Content.asp", tabName: "防火墙规则"},
					{url: "NULL", tabName: "__INHERIT__"}
				]
			},
			{
