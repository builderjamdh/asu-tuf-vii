...
void set_radio(int on, int unit, int subunit)
{
	...
	// TODO: handle subunit
#if defined(RTCONFIG_WLMODULE_MT7629_AP) || defined(RTCONFIG_WLMODULE_MT7915D_AP) || defined(RTCONFIG_WLMODULE_MT7628_AP) || defined(RTCONFIG_WLMODULE_MT7663E_AP) || defined(RTCONFIG_MULTILAN_CFG) 
