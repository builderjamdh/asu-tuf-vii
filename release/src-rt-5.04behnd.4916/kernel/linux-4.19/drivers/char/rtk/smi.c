...
#define MDC_MDIO_WRITE(preamableLength, phyID, regID, data) mdio_write_c22_register(phyID, regID, data)
#define MDC_MDIO_READ(preamableLength, phyID, regID, pData) mdio_read(phyID, regID, pData)


void mdio_read( rtk_uint32 phyID, rtk_uint32 regID, rtk_uint32* pData)
{
     mdio_read_c22_register(phyID, regID,(uint16_t*) pData);
     *pData = *pData & 0x0ffff;
}
