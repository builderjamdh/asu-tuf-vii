...
#else
#define RTK_API_LOCK() 		//spin_lock_irqsave(&api_spinlock, api_irqflags)
#define RTK_API_UNLOCK()	//spin_unlock_irqrestore(&api_spinlock, api_irqflags)
#endif
